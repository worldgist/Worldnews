...
export default function EntertainmentNewsPage() {
  ...
  const stories = useMemo(() => getPublicByCategory('Entertainment', articles), [articles])
  ...
  return (
    <main className="container">
      ...
      {stories.length === 0 ? (
        <p className="empty-state">No entertainment stories available yet.</p>
      ) : (
        <>
          ...
          <PostPagination
            ...
            ariaLabel="Entertainment news pagination"
          />
        </>
      )}
